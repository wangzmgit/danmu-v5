<template>
    <div class="upload-cover">
        <n-upload name="carousel" multiple directory-dnd :show-file-list="false" :action="carouselUrl"
            :headers="headers" @before-upload="beforeUploadCover" @change="handleChange">
