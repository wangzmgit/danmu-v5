<template>
    ...
    <div class="control-box">
        ...
        <div class="control-right">
            <div></div>
            <w-button v-show="full" class="res" type="text" @click="showMenu('res')">{{ videoInfo.resText }}</w-button>
            ...
            <w-button v-show="full" class="speed" type="text" @click="showMenu('speed')">{{ videoInfo.speedText }}
            </w-button>
            ...
            <!-- 音量 -->
            <w-button v-show="full" class="right-icon" type="text" @click="showMenu('volume')">
